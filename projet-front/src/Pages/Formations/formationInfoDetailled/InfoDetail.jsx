...
const InfoDetail = () => {
  const { id } = useParams();
  const formation = InfoFormations.find((item) => item.id === parseInt(id));
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-900 via-blue-800 to-gray-900 p-8 text-white">
      <div className="max-w-l mx-auto bg-gradient-to-t from-gray-800 to-gray-700 rounded-xl shadow-lg overflow-hidden">
        <br /><br />
